import{_ as v,g as A,r as j,e as D,f as E,h as I,c as m,o as T,a as k,w,i as W,F as C,j as z,n as h,t as P,u as s,v as q,k as H,l as S}from"./index-CG9o0Qjc.js";const x=`# API文档\r
\r
## 核心接口\r
\r
### 模型响应生成\r
...
`,F=["onClick"],O=["onClick"],M={__name:"DevDoc",setup(U){let b=A().proxy.config.settings,u=A().proxy.screen,l=j([]),i=null,c=j([]),p=D(!1);function f(t,e){if(t.localName==="h2"&&u.type==="hor"){c[e]=!c[e];return}t.scrollIntoView(),u.type==="ver"&&i.scrollBy(0,-200)}function y(){const t=i.scrollHeight,e=i.scrollTop,n=u.height;let r=l.map(a=>parseInt(a.dom.offsetTop-e));r.push(parseInt(t-e)),l.forEach((a,o)=>{r[o]<0&&r[o+1]<=0||r[o]>=n&&r[o+1]>n?a.inSight=!1:a.inSight=!0;let d=a.items.map(g=>parseInt(g.dom.offsetTop-e));d.push(parseInt(r[o+1])),a.items.forEach((g,_)=>{d[_]<0&&d[_+1]<=0||d[_]>=n&&d[_+1]>n?g.inSight=!1:g.inSight=!0})})}function B(){if(!i)return;l.length=0;let t=[];i.querySelectorAll("h2").forEach(n=>t.push(n)),i.querySelectorAll("h3").forEach(n=>t.push(n)),t.sort((n,r)=>n.getAttribute("data-line")-r.getAttribute("data-line"));let e=null;t.forEach((n,r)=>{c[r]===void 0&&(c[r]=!0),n.localName==="h2"?(e!==null&&l.push(e),e={title:n.innerText,dom:n,inSight:!1,items:[]}):n.localName==="h3"&&e.items.push({title:n.innerText,dom:n,inSight:!1})}),l.push(e),y()}return E(()=>{i=document.getElementsByClassName("md-editor-preview-wrapper")[0],i.addEventListener("scroll",y),B()}),(t,e)=>{const n=I("Markdown");return T(),m("div",{class:h(["area",s(u).type])},[k("div",{class:h(["menu",{active:s(p)}])},[(T(!0),m(C,null,z(s(l),(r,a)=>(T(),m("div",null,[k("div",{class:h(["class","buttonEffect",{active:r.inSight}]),onClick:o=>f(r.dom,a)},"> "+P(r.title),11,F),k("div",{class:h(["folder",{folded:s(c)[a]&&s(u).type==="hor"}])},[(T(!0),m(C,null,z(r.items,o=>(T(),m("div",{class:h(["item","buttonEffect",{active:o.inSight}]),onClick:d=>f(o.dom)},P(o.title),11,O))),256))],2)]))),256))],2),w(k("img",{class:"menuButton buttonEffect",src:H,onClick:e[0]||(e[0]=r=>S(p)?p.value=!s(p):p=!s(p))},null,512),[[q,s(u).type==="ver"]]),W(n,{class:"md",md:s(x),theme:s(b).theme,onOnHtmlChanged:B},null,8,["md","theme"])],2)}}},N=v(M,[["__scopeId","data-v-f2683abf"]]);export{N as default};
