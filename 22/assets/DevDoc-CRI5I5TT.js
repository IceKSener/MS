...
\r
\`\`\`http\r
GET /get_qa?session_id=abc123&question_id=q1 HTTP/1.1\r
Authorization: Bearer <your_token>\r
\`\`\`\r
\r
#### 成功响应\r
...
`,d={class:"area"},c={__name:"DevDoc",setup(_){let r=o().proxy.config.settings;return(T,m)=>{const e=s("Markdown");return a(),i("div",d,[u(e,{class:"md",md:n(p),theme:n(r).theme},null,8,["md","theme"])])}}},h=t(c,[["__scopeId","data-v-89b76389"]]);export{h as default};
